...
int invoke_lambda(Lambda *l) {
    ...
    typedef int (*Func10)(void *, void *, void *, void *, void *, void *, void *, void *, void *,
                          void *);
    if (l == NULL)
        return 0;
    if (l->func == NULL)
    ...
    case 6:
        return ((Func6)l->func)(l->args[0], l->args[1], l->args[2], l->args[3], l->args[4],
                                l->args[5]);
    case 7:
        return ((Func7)l->func)(l->args[0], l->args[1], l->args[2], l->args[3], l->args[4],
                                l->args[5], l->args[6]);
    case 8:
        return ((Func8)l->func)(l->args[0], l->args[1], l->args[2], l->args[3], l->args[4],
                                l->args[5], l->args[6], l->args[7]);
    case 9:
        return ((Func9)l->func)(l->args[0], l->args[1], l->args[2], l->args[3], l->args[4],
                                l->args[5], l->args[6], l->args[7], l->args[8]);
    case 10:
        return ((Func10)l->func)(l->args[0], l->args[1], l->args[2], l->args[3], l->args[4],
                                 l->args[5], l->args[6], l->args[7], l->args[8], l->args[9]);
    default:
...
int is_lambda(Lambda *l) { return l->magic == MAGIC_NUMBER; }
